...
void display(list<int>& nl){
    for (list<int>::const_iterator iter = nl.begin(); iter != nl.end(); iter++) {
        cout<< *iter<<" ";
    }
}
void display_for_range(list<int>& nl){
    for (int x: nl){
        cout<<x<<" ";
    }
}
...
//Task 19
list<int>::const_iterator ourFind(const list<int>& nl, int numberToFind){
...
int main() {
    ...
    list<int>::const_iterator iter4 = iter_find(l, 99);
    ...
    cout << "Task 19:\n";
    list<int>::const_iterator ourIter = ourFind(l, 13);
